            ...
            <aside className={cn(css.sideBar, {
                ...
                <div className={css.sideBar__grid}>
                    <React.Fragment >
                        ...
                        {isOpen && <React.Fragment >              <div className={css.sideBar__grid__item}>
                        ...
                        {isOpen && <React.Fragment >
                            ...
                            <div className={css.sideBar__grid__item}>
                                ...
                                <p className={css.sideBar__grid__item__text}>Переглянути пізніше</p>
                            </div>
                            <div className={css.sideBar__grid__item}>
                                <span className="fas fa-thumbs-up"></span>
                                <p className={css.sideBar__grid__item__text}>Відео, які сподобались</p>
                            </div>
                            <hr />
